...
export default function DeliveryPickupSelector({ value, onChange }: Props) {
  return (
    <div className="card p-5">
      <h3 className="text-lg font-bold text-[#07245e]">Is this for Delivery or Pickup?</h3>
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        ...
        >
          <p className="font-semibold text-[#07245e]">Delivery</p>
        ...
        >
          <p className="font-semibold text-[#07245e]">Pickup</p>
