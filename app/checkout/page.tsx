  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="container-shell py-12">
        <h1 className="text-4xl font-serif font-bold text-[#07245e] tracking-tight">Checkout</h1>
            ...
            <div className="space-y-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 >
                   ...
                   <span className="text-lg font-bold text-[#07245e]">Delivery</span>
                 ...
                 >
                   ...
                   <span className="text-lg font-bold text-[#07245e]">Pickup</span>
              ...
              {mode === "delivery" && (
                ...
                >
                  <div className="border-t border-slate-100 pt-8">
                    <h3 className="text-2xl font-serif font-bold text-[#07245e] mb-6 tracking-tight">Delivery Address</h3>
                ...
                >
                  <div className="border-t border-slate-100 pt-8">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-2xl font-serif font-bold text-[#07245e] tracking-tight">
                    ...
                    {selectedStore && (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <p className="text-lg font-bold text-[#07245e] leading-tight">{selectedStore.name}</p>
...
function PaymentSection() {
  return (
    <div className="border-t border-slate-100 pt-8">
      <h3 className="text-2xl font-serif font-bold text-[#07245e] mb-6 tracking-tight">Payment</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button className="rounded-2xl border-2 border-orange-500 bg-orange-50/50 p-5 text-left font-bold text-[#07245e]">
          Cash on Delivery
        </button>
