        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-12 pr-4 focus:border-[#3a9688] focus:outline-none" 
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`rounded-lg border px-4 py-2 text-sm font-medium transition-all ${
                activeCategory === cat 
                ? "bg-[#3a9688] border-[#3a9688] text-white shadow-sm" 
                : "bg-white border-slate-200 text-slate-600 hover:border-[#3a9688] hover:text-[#3a9688]"
              }`}
            >
              {cat}
            </button>
